...
namespace ML_Engine::Graphics
{
	...
	struct VertexP
	{
		...
		// static constexpr uint32_t Format = VE_Position
	...
	struct Vertex
	{
		// sets the vertex input data expected to be passed to the shader (pos, normal, tan, texcoord, blendindices, weightindicies)
