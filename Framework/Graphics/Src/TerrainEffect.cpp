...
void TerrainEffect::DebugUI()
{
	if (ImGui::CollapsingHeader("Terrain Effect", ImGuiTreeNodeFlags_DefaultOpen))
	{
		...
		ImGui::DragFloat("LowHeight##TrainEffect", &mSettingsData.lowHeight, 0.1f, 0.0f, 20.0f);
		ImGui::DragFloat("BlendHeight##TrainEffect", &mSettingsData.blendHeight, 0.1f, 0.0f, 20.0f);
	}
}
